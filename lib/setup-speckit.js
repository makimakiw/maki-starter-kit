...
`;
  ...
  await fs.writeFile(
    path.join(projectDir, 'SPECKIT-WORKFLOW.md'),
    workflowContent
  );
}
...
- The Next.js app is located in the ${appName}/ directory`;
        ...
        try {
          await createSpecKitWorkflowGuide(projectDir, projectInfo);
          ...
          spinner.warn(chalk.yellow('Workflow guide creation skipped'));
        }
