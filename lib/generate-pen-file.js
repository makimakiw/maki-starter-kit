...
**VISUAL ADJUSTMENTS (matching design system exactly):**
- Button text: 16px (base) and 18px (large) using typography variables
- Button heights: 40px (default) and 48px (large) matching design tokens
- Button padding: 24px (default) and 32px (large) horizontal
- Font weight: 500 (medium) for all button text
- Input fields: 40px tall to match button default height
- Input labels: 14px (sm), input text: 16px (base)
- Helper text: 12px (xs)
...
Parameters:
  ...
  operations: |
    ...
    // Button Primary Component (40px height with 16px text)
    btnPrimary=I("canvas", {
      type: "frame",
      name: "Button Primary",
      x: 100,
    ...
    // Input Default (40px height, 14px label, 16px input text)
...
- ✅ **Button text at 16px/18px** using typography variables, font-weight 500
- ✅ **Button heights at 40px/48px** matching design system exactly
- ✅ **Input fields at 40px** with 14px labels, 12px helper text
...
After generation, verify these match your design system webpage exactly:

**Buttons:**
- Default height: 40px (matches --size-button-default)
- Large height: 48px (matches --size-button-large)
- Text size: 16px base, 18px large
- Padding: 24px (default), 32px (large) horizontal
- Font weight: 500
- Border radius: pill (999px)

**Inputs:**
- Height: 40px (same as button default)
- Input text: 16px
- Labels: 14px
- Helper text: 12px
...
**Test:** Open your design system webpage (localhost:3000) and the .pen file side-by-side. All measurements should match exactly!
...
2. **Verify visual quality:**
   - ✅ Button text uses typography variables (16px base, 18px large) with -0.2 letter-spacing
   - ✅ Button heights match design system (40px default, 48px large)
   - ✅ Input fields match button height (40px for touch targets)
   - ✅ Input labels are 14px (sm), helper text 12px (xs)
...
- 🔘 **Professional buttons** at 40px/48px with 16px/18px text matching design system
- 📝 **Well-designed inputs** at 40px with 14px labels, 12px helper text
- 🪟 **Beautiful modal** with shadow-xl and 40px buttons
